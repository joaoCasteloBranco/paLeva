...
describe 'User creates a beverage' do
  it "with success" do
    ...
    patch restaurant_beverage_path(restaurant_id: restaurant.id, id: beverage.id, params: {
      beverage: {
        name: "Novo Nome"
      }
    })
    ...
    expect(response).to redirect_to restaurant_beverage_path(restaurant_id: restaurant.id, id: beverage.id)
  end
